...
std::string paramsFilePath = "/home/pjfsd/CATKIN_FS/src/camera_node/src/params.txt"; 

const float REKT_SIZE =10; //batch size for the data
...
void plot_pts(std::vector<Yolo::Detection>& res, cv::Mat &img2)
{
...
class CameraNode { 
	private : 
		...
		//Rektnet rektnet = Rektnet(10); //RektNet for Keypoint Detection//RektNet for Keypoint Detection  
...
void ProcessImage(cv::Mat &image)  {
	...
	//rektnet inference  
        ...
        //pipeline.plot_pts(yolov5.res_sorted,image);  
        } 
